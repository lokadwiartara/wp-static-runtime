...
class Redis_Index {
    ...
    public static function boot(): void {
        ...
        try {
            ...
            call_user_func( 'error_log', '[WSR Redis] Connection failed: ' . $e->getMessage() );
            self::$enabled = false;
        }
    }
    ...
    public static function index_write( bool $continue, string $url ): bool {
        ...
        try {
            ...
            call_user_func( 'error_log', '[WSR Redis] index_write: ' . $e->getMessage() );
    ...
    public static function store_full_page( string $uri, string $file ): void {
        ...
        try {
            ...
            call_user_func( 'error_log', '[WSR Redis] store_full_page: ' . $e->getMessage() );
        }
    }
    ...
    public static function on_purge( string $url ): void {
        ...
        try {
            ...
            call_user_func( 'error_log', '[WSR Redis] on_purge: ' . $e->getMessage() );
        }
    }
    ...
    public static function on_flush(): void {
        ...
        try {
            ...
            call_user_func( 'error_log', '[WSR Redis] on_flush: ' . $e->getMessage() );
        }
    }
