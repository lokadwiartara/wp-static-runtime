...
class Memcached_Index {
    ...
    public static function boot(): void {
        ...
        try {
            ...
            error_log( '[WSR Memcached] Connection failed: ' . $e->getMessage() );
            self::$enabled = false;
        }
    }
    ...
    private static function connect( string $host, int $port ): void {
        ...
        if ( self::$mc->set( self::$prefix . 'ping', '1', 5 ) === false ) {
            throw new \Exception( 'Cannot write to Memcached at ' . $host . ':' . $port );
        }
    }
    ...
    public static function index_write( bool $continue, string $url ): bool {
        ...
        try {
            ...
            error_log( '[WSR Memcached] index_write: ' . $e->getMessage() );
            return true;
        }
    }
    ...
    public static function store_full_page( string $uri, string $file ): void {
        ...
        try {
            ...
            error_log( '[WSR Memcached] store_full_page: ' . $e->getMessage() );
        }
    }
    ...
    public static function on_purge( string $url ): void {
        ...
        try {
            ...
            error_log( '[WSR Memcached] on_purge: ' . $e->getMessage() );
        }
    }
    ...
    public static function on_flush(): void {
        ...
        try {
            ...
            error_log( '[WSR Memcached] on_flush: ' . $e->getMessage() );
        }
    }
